<%-- 
    Document   : feedback
    Created on : Nov 8, 2023, 5:38:48 PM
    Author     : Admin
--%>
                        ...
                        <table border="1" style="width: 100%; text-align: center;">
                            <thead >
                                <tr>
                                    ...
                                    <th style="font-size: 30px;">Content</th>                            
                                </tr>
                            </thead>
                            <tbody>
                                <c:forEach items="${requestScope.listfeedback}" var="l">
                                    <tr>
                                        <td class="col-md-4">${l.feedback_name}</td>                            
                                        <td class="col-md-2">${l.feedback_content}</td>                                
                                    </tr>                     
                                </c:forEach>
                            </tbody>
                        </table>
